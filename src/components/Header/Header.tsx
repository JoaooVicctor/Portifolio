...
export default function Header() {
  return (
    <header className="w-full h-screen bg-linear-to-r from-[#010408] to-[#162542] flex flex-col justify-center items-center px-6 pt-30 text-white text-center">
      ...
      <h1 className="text-5xl sm:text-7xl font-bold mb-3">Olá, sou <span className="text-blue-500">João Victor</span></h1>

      <h2 className="text-2xl sm:text-3xl text-gray-300 mb-6 font-bold">
        Frontend Developer
      </h2>

      <p className="max-w-2xl text-gray-400 text-base sm:texr mb-10 leading-relaxed">
      ...
      <a href="#projetos" className="animate-bounce text-gray-400 mt-15">
